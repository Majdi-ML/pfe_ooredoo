...
return new class extends Migration
{
    ...
    {
        Schema::create('requetessql', function (Blueprint $table) {
            ...
            $table->text('requeteSql')->nullable();
            $table->string('usernameDbName')->nullable();
            $table->text('resultatAttenduDeLaRequete')->nullable();
    ...
    {
        Schema::dropIfExists('requetessql');
    }
};
