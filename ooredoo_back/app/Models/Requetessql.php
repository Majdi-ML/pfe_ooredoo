 ...
 * @property string|null $requeteSql
 * @property string|null $usernameDbName
 * @property string|null $resultatAttenduDeLaRequete
 ...
 * @package App\Models
 */
class Requetessql extends Model
{
	protected $table = 'requetessql';
	...
	{
		return $this->belongsToMany(Serveur::class, 'requetessql_serveurs');
	}
}
